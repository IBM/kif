...
setuptools.setup(
    ...
    extras_require={
        'all': [*[ 'myst_nb', 'sphinx-rtd-theme', ],*[ 'click', 'ddgs', 'graphviz', 'jpype1', 'pandas', 'pandas-stubs', 'rich', 'types-click', ],*['flake8', 'isort', 'mypy', 'pylint', 'pyright', 'pytest', 'pytest-asyncio', 'pytest-cov', 'pytest-mypy', 'pyupgrade', 'setuptools', 'tox']],
        'docs': [ 'myst_nb', 'sphinx-rtd-theme', ],
        'extra': [ 'click', 'ddgs', 'graphviz', 'jpype1', 'pandas', 'pandas-stubs', 'rich', 'types-click', ],
