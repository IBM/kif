...
dog = Q(144, 'dog')
cat = Q(146, 'house cat'),
hamster = Q(204175, 'hamster'),
monkey = Q(1367, 'monkey'),
duck = Q(3736439, 'duck'),
quail = Q(28358, 'common quail'),
chicken = Q(780, 'chicken'),
pigeon = Q(2984138, 'pigeon'),
...
intradermal = Q(1671547, 'intradermal injection')
endobronchial = Q(1340651, 'endobronchial')
intravaginal = Q(6058566, 'intravaginal administration')
intramuscular = Q(432083, 'intramuscular injection')
intracrebral = Q(23931538, 'Intracerebral administration')
intracerebral = Q(23931538, 'Intracerebral administration')
