    ...
    def test_value_fp_subject(self) -> None:
        ...
        xf(F(subject=wd.Ginga, snak_mask=F.VALUE_SNAK, value_mask=F.ITEM),
           {wd.copyright_license(wd.Ginga, wd.GNU_General_Public_License),
            ...
            wd.country_of_origin(wd.Ginga, wd.Brazil),
            wd.different_from(wd.Ginga, wd.Q(1411420)),
            wd.instance_of(wd.Ginga, wd.system_software),
            wd.named_after(wd.Ginga, wd.Q(1411420)),
            wd.subclass_of(wd.Ginga, wd.middleware)})
