...
class Test(kif_TestCase):
    ...
    def test_check(self) -> None:
        self.assert_raises_check_error(StringTemplate, 0)
        self.assert_raises_check_error(StringTemplate, {})
        self.assert_raises_check_error(StringTemplate, IRI('x'))
        self.assert_raises_check_error(StringTemplate, StringTemplate('x'))
        # success
        assert_type(
